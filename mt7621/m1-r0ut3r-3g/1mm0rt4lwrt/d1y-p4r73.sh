...
# upgrade config
wget --no-check-certificate https://raw.githubusercontent.com/0xACE8/r4m1ps/main/mt7621/m1-r0ut3r-3g/1mm0rt4lwrt/zzz-updata-settings2 -O package/base-files/files/etc/uci-defaults/zzz-updata-settings
